...
#define STR_MAXSIZE	258						// максимальная длина строкового литерала
...
namespace IT
{
	enum IDDATATYPE { NUM = 1, STR = 2, PROC = 3, UNDEF };				// типы данных идентификаторов: числовой, строковый, без типа (void), неопределенный
