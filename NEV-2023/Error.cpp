...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(204, "Лексическая ошибка: Неверная запись шеснадцатеричного числа"),
		...
		ERROR_ENTRY(319, "Семантическая ошибка: Деление на ноль (идентификаторов равен нулю)"),
